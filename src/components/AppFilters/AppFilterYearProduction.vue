<template>
  <AppFilterToggle @isFilterOpen="setValue">
    <template #button-title> Года производства</template>
  </AppFilterToggle>
  <div v-show="isFilterOpen" :class="$style['filter-track-wrapper']">
    ...
    <div :class="$style['filter-track']">
      <AppFilterSliderTrack>
        <AppFilterSliderThumb />
        <AppFilterSliderThumb />
      </AppFilterSliderTrack>
    </div>
  </div>
...
import AppFilterSliderTrack from "@/components/AppFilters/FilterSlide/AppFilterSliderTrack";
import AppFilterSliderThumb from "@/components/AppFilters/FilterSlide/AppFilterSliderThumb";

export default {
  name: "AppFilterYearProduction",
  components: {
    AppFilterSliderTrack,
    AppFilterToggle,
    AppFilterSliderThumb,
